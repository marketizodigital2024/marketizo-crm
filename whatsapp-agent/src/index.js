...
async function sendMorningReport() {
  ...
  const completion = await openai.chat.completions.create({
    ...
    ...reasoningOptions(),
    messages: [
      { role: "system", content: "Napiši Miljanu kratak jutarnji vlasnički pregled na srpskom kao osoba koja poznaje tim i izdvaja samo ono važno. Proceni kontekst i poslovnu posledicu. Za svakog relevantnog klijenta koristi oblik: *Kratko ime klijenta* — 🔴 Hitno, 🟡 Potrebna pažnja ili 🟢 Pozitivno. Ispod napiši dva do četiri kratka prirodna pasusa: šta se dogodilo, trenutno stanje i zašto je važno. Završi sa *Sledeći korak:* i jednom konkretnom akcijom, odgovornom osobom i rokom kada su poznati. Ciljaj približno 90–160 reči po klijentu i ostavi prazan red između pasusa. Bez tabela, sirovog nabrajanja poruka, botovskog uvoda i praznih fraza. Svi ljudi iz teamMembers su zaposleni Marketiza, nikada klijenti. pendingReplies znači da klijent čeka odgovor zaposlenog duže od tri radna sata. silentClients znači da zaposleni čeka odgovor klijenta duže od 48 sati. Pre zaključka proveri recentGroupMessages. Ako je rešeno, ne navodi ga. Ako nije, reci ko treba da preuzme i do kada. Miljanu izdvoji samo ono što traži njegovu odluku ili nosi ozbiljan rizik. Ne izmišljaj činjenice." },
