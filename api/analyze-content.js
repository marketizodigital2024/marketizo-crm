...
function schema() {
  ...
  return {
    ...
    required: ["overallScore", "offerRead", "mainConclusion", "mainReason", "urgency", "consequence", "previewCards", "coverage", "scores", "priorities", "examples", "contentIdeas"],
    properties: {
      overallScore: { type: "integer", minimum: 30, maximum: 95 }, offerRead: string, mainConclusion: string, mainReason: string, urgency: string, consequence: string, previewCards: { type: "array", minItems: 6, maxItems: 6, items: { type: "object", additionalProperties: false, required: ["label", "title", "body"], properties: { label: string, title: string, body: string } } },
