  ...
  if (profileTarget && employee && isEmployeeProfilePage) {
    ...
    profileTarget.innerHTML = `
      ...
      <section class="employee-summary-grid profile-panel" data-profile-panel="summary">
        ...
        <article><span>Ciljevi</span><strong>${goalProgress}%</strong><div class="profile-progress-track" aria-label="Napredak ciljeva ${goalProgress}%"><span style="width:${Math.max(0, Math.min(100, goalProgress))}%"></span></div><small>${activeGoals.length} aktivnih</small></article>
      </section>
